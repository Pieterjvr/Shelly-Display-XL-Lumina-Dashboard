...
window.CONFIG = {
    ...
    HA_TOKEN: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiI2NWEyMGFiZThkNTE0YmZjYmM5ZmExZTQ2MzkxMTI1ZCIsImlhdCI6MTc3NzIwODU3OCwiZXhwIjoyMDkyNTY4NTc4fQ.SIEbgbZ9OTTfEuFYtONsFnVO_t9kr6UHn33Xh6RBOBA",
    ...
    ENTITIES: {
        ...
        // Quick Access Tiles
        QUICK_TILES: {
            lights_on_count: 'sensor.light_on_count',
            main_alarm: 'alarm_control_panel.house',
            pool_pump: 'switch.pool_pump_switch',
            geyser_status: 'sensor.backup_backup_manager_state'
        },
        ...
        WEATHER: {
            ...
            forecast_daily: 'weather.pirateweather' // To pull daily forecast attributes if available
        },
